...
import { card, cardContent, cardImage, cardAvatar, cardActions, cardText } from './styles/card-carousel.css';
...
const content = div({className: cardContent}, [avatar, name, actionIcons, textContainer]);
